...
class ExecutionHandler(object):
    """
    The ExecutionHandler abtract class handles the interaction between a set of 
    order objects generated by a Portfolio and the ltimate set of Fill objects that 
    ...
    This allows strategies to be backtested in a very similar manner to hte live trading engine.
    """
